/**
 * Created by mityabeldii on 21.06.2017.
 */
            ...
            <View style={{width: '100%', backgroundColor: mvConsts.tabBackColor, borderRadius: mvConsts.littleRadius, alignItems: 'center', justifyContent: 'center', shadowColor: mvConsts.shadowColor, shadowRadius: mvConsts.shadowRadius, shadowOpacity: mvConsts.shadowOpacity, shadowOffset: mvConsts.shadowOffset, }}>
                <View style={{width: '90%', borderWidth: 1, padding: '2%', marginTop: '3%', marginBottom: '2%', borderColor: mvConsts.fontColorSecondary, borderRadius: mvConsts.bigRadius, alignItems: 'center', }}>
                    <TextInput
                        ...
                        autoCapitalize={'none'}
                        autoCorrect={false}
                        onFocus={() => {this.props.onTyping()}}
                        onEndEditing={() => {this.props.onTyping()}}
                ...
                <TouchableOpacity style={{width: '90%', height: inputHeight * 2, borderRadius: mvConsts.littleRadius, alignItems: 'center', }} onPress={() => {this.onButtonPress()}}>
                    <MVButton text={store.dictionary.signin} style={mvConsts.buttonStyles.accept} borderRadius={mvConsts.bigRadius} />
                </TouchableOpacity>
                <TouchableOpacity style={{width: '100%', marginTop: '5%', marginBottom: '5%', justifyContent: 'center', alignItems: 'center', }} onPress={() => {this.props.goToSignUp()}}>
                    <Text style={{fontFamily: mvConsts.fontFamilyRegular, fontSize: mvConsts.fontSizeMiddle * 0.85, color: mvConsts.fontColorSecondary, alignItems: 'center', }} >{store.dictionary.donthaveanaccount}</Text>
                </TouchableOpacity>
            </View>
        );
    }
