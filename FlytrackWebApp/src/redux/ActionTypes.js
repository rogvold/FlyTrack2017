...
//realtime
export const REALTIME_MESSAGE_RECEIVED = 'REALTIME_MESSAGE_RECEIVED'

//dashboard
export const SELECT_AIRCRAFT_IN_DASHBOARD = 'SELECT_AIRCRAFT_IN_DASHBOARD'
export const SELECT_MANY_AIRCRAFTS_IN_DASHBOARD = 'SELECT_MANY_AIRCRAFTS_IN_DASHBOARD'
export const UNSELECT_AIRCRAFT_IN_DASHBOARD = 'UNSELECT_AIRCRAFT_IN_DASHBOARD'
export const SET_TIMESTAMP_IN_DASHBOARD = 'SET_TIMESTAMP_IN_DASHBOARD'

export const SET_AIRCRAFTS_FROM_HISTORY = 'SET_AIRCRAFTS_FROM_HISTORY'
export const SET_CURRENT_TIME = 'SET_CURRENT_TIME'
export const SHOW_ACTIVE_PLANES = 'SHOW_ACTIVE_PLANES'
